_base_ = [
    '/home/neau/sdb/mmyolo/configs/yolov6/yolov6_v3_s_syncbn_fast_8xb32-300e_coco.py'
]
...
custom_imports = dict(
    imports=['leaf_model_tools.hooks','leaf_model_tools.GDNeck','leaf_model_tools.AFPN','leaf_model_tools.AFPN4','leaf_model_tools.EMA'],
...
data_root = '/home/neau/trainset/leaf_ag'
...
_base_.train_dataloader.dataset.ann_file = 'output_file_train.json'
...
_base_.val_dataloader.dataset.ann_file = 'output_file_test.json'
_base_.val_dataloader.dataset.data_prefix = dict(img='./')

_base_.test_dataloader = _base_.val_dataloader

_base_.val_evaluator.ann_file = data_root + '/output_file_test.json'
